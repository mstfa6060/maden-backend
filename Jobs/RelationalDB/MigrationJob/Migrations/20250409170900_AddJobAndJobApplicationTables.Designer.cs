...
namespace Jobs.RelationalDB.MigrationJob.Migrations
{
    ...
    [Migration("20250409170900_AddJobAndJobApplicationTables")]
    partial class AddJobAndJobApplicationTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessModules.Hirovo.Domain.Entities.Job", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("BusinessModules.Hirovo.Domain.Entities.JobApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Common.Definitions.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 4, 9, 17, 9, 0, 331, DateTimeKind.Utc).AddTicks(3135),
                            IsDeleted = false,
                            IsSystemRole = true,
                            Name = "Admin",
                            UpdatedAt = new DateTime(2025, 4, 9, 17, 9, 0, 331, DateTimeKind.Utc).AddTicks(3138)
                        },
                        new
                        {
                            Id = new Guid("b3f8a7d1-4e2c-4a3e-8b5a-d3e7b9c5e2f1"),
                            CreatedAt = new DateTime(2025, 4, 9, 17, 9, 0, 331, DateTimeKind.Utc).AddTicks(3144),
                            IsDeleted = false,
                            IsSystemRole = true,
                            Name = "Employer",
                            UpdatedAt = new DateTime(2025, 4, 9, 17, 9, 0, 331, DateTimeKind.Utc).AddTicks(3144)
                        });
                });
            ...
            modelBuilder.Entity("Common.Definitions.Domain.Entities.RolePermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c2ab1a28-9027-415c-a96e-397359568926"),
                            CreatedAt = new DateTime(2025, 4, 9, 17, 9, 0, 331, DateTimeKind.Utc).AddTicks(3321),
                            IsDeleted = false,
                            Permission = "ManageUsers",
                            RoleId = new Guid("a1d5b3e4-8e5a-4b3c-9ef5-d3e5a3b7c1f8"),
                            UpdatedAt = new DateTime(2025, 4, 9, 17, 9, 0, 331, DateTimeKind.Utc).AddTicks(3321)
                        },
                        new
                        {
                            Id = new Guid("58e67985-0368-49e7-81d0-6a2d008104ab"),
                            CreatedAt = new DateTime(2025, 4, 9, 17, 9, 0, 331, DateTimeKind.Utc).AddTicks(3323),
                            IsDeleted = false,
                            Permission = "ManageRoles",
                            RoleId = new Guid("a1d5b3e4-8e5a-4b3c-9ef5-d3e5a3b7c1f8"),
                            UpdatedAt = new DateTime(2025, 4, 9, 17, 9, 0, 331, DateTimeKind.Utc).AddTicks(3324)
                        },
                        new
                        {
                            Id = new Guid("f38ba4f1-c16e-4d26-ac9e-a9a71fdb61d4"),
                            CreatedAt = new DateTime(2025, 4, 9, 17, 9, 0, 331, DateTimeKind.Utc).AddTicks(3326),
                            IsDeleted = false,
                            Permission = "PostJobs",
                            RoleId = new Guid("b3f8a7d1-4e2c-4a3e-8b5a-d3e7b9c5e2f1"),
                            UpdatedAt = new DateTime(2025, 4, 9, 17, 9, 0, 331, DateTimeKind.Utc).AddTicks(3327)
                        },
                        new
                        {
                            Id = new Guid("823e663b-c3b5-4706-aa9c-48de6034dbd5"),
                            CreatedAt = new DateTime(2025, 4, 9, 17, 9, 0, 331, DateTimeKind.Utc).AddTicks(3329),
                            IsDeleted = false,
                            Permission = "ViewWorkers",
                            RoleId = new Guid("b3f8a7d1-4e2c-4a3e-8b5a-d3e7b9c5e2f1"),
                            UpdatedAt = new DateTime(2025, 4, 9, 17, 9, 0, 331, DateTimeKind.Utc).AddTicks(3330)
                        });
                });
            ...
            modelBuilder.Entity("BusinessModules.Hirovo.Domain.Entities.Job", b =>
                {
                    b.HasOne("Common.Definitions.Domain.Entities.User", "Employer")
                        .WithMany()
            ...
            modelBuilder.Entity("BusinessModules.Hirovo.Domain.Entities.JobApplication", b =>
                {
                    b.HasOne("BusinessModules.Hirovo.Domain.Entities.Job", "Job")
                        .WithMany()
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Common.Definitions.Domain.Entities.User", "Worker")
                        .WithMany()
