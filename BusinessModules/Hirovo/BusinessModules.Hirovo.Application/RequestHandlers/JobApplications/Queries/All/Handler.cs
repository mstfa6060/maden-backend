...
public class Handler : IRequestHandler
{
	...
	public async Task<ArfBlocksRequestResult> Handle(IRequestModel payload, EndpointContext context, CancellationToken cancellationToken)
	{
		...
		var (applications, page) = await _dataAccessLayer.All(requestPayload.Sorting, requestPayload.Filters, requestPayload.PageRequest);
		var response = mapper.MapToResponse(applications);
